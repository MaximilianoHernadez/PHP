...
$pdf->SetXY(25,10);
$pdf->drawTextBox(utf8_decode("CONTRATO DE PRESTACIÓN  DE SERVICIOS"),155,10, 'C','T','','false');
$pdf->SetXY(100,5);
$pdf->drawTextBox(utf8_decode($a['12']),155,10,'C','M','','false');
$pdf->SetXY(25,25);
$pdf->drawTextBox(utf8_decode("CONTRATO DE PRESTACIÓN DE SERVICIOS QUE CELEBRAN, POR UNA PARTE ASESORÍA, CONSTRUCCIÓN, INSTALACIÓN Y MANTENIMIENTO, S.A. DE C.V., A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ COMO \"ACIMSA\", REPRESENTADA EN ESTE ACTO POR EL ING. JOAQUIN ACARDIO ANTONIO PAGAZA PEREZ, EN SU CARÁCTER DE REPRESENTANTE LEGAL, Y, POR LA OTRA ".$a['1'].", REPRESENTADA EN ESTE ACTO POR , EN SU CARÁCTER DE APODERADO LEGAL, A QUIEN EN LO SUCESIVO SE LE DENOMINARÁ COMO EL \"PRESTADOR DE SERVICIOS\", AL TENOR DE LAS SIGUIENTES DECLARACIONES Y CLÁUSULAS:"),160,50,'J','T','','false');
$pdf->SetXY(25,75);
...
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("
II.1.    Que es una persona física inscrita en el Registro Federal de Contribuyentes bajo el número ".$a['10'].".

II.2.   Que cuenta con las facultades y capacidad jurídica para celebrar el presente contrato."),155,30,'J','T','','false');
...
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("
II.3   Que su actividad preponderante  del \"PRESTADOR DE SERVICIOS\" consiste en ".$a['22'].", y que no forma parte del objeto social, ni de la actividad preponderante de \"ACIMSA\", por lo que representa un servicio especializado requerido por ésta.
...
II.3.   Que cuenta con la capacidad técnica, legal, financiera y administrativa para ejecutar los trabajos objeto del presente contrato.
...
II.4.1  Que conoce los requerimientos exigidos por ". $a['13'] .".

II.5.   Que es su deseo celebrar el presente contrato con \"ACIMSA\" con el fin de dar cumplimiento a las actividades requeridas por esta. 

II.6. Que tiene su domicilio ubicado en ".$a['11'].".
"),155,120,'J','T','','false');
$pdf->SetXY(30,130);
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("Ambas partes manifiestan que, efectuadas las anteriores declaraciones, convienen en formalizar el presente contrato al tenor de las siguientes."),155,10,'J','T','','false');
$pdf->SetXY(25,140);
$pdf->SetFont('Arial','B',12);
...
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("
El monto preciso por cada servicio prestado será determinado por las órdenes de compra que se deriven del presente contrato, mismas que reflejarán los precios determinados en el catálogo de precios que se contiene en el \"Anexo I\" del presente contrato.
"),155,25,'J','T','','false');
...
para determinar las acciones a tomar para completar la ejecución de los servicios retrasados, si no se llegare a un acuerdo; \"ACIMSA\", además de aplicar las penas convencionales correspondientes, podrá determinar la rescisión del presente contrato, de acuerdo a la cláusula Décima Séptima del presente contrato, a juicio de \"ACIMSA\".
Las partes convienen, adicionalmente a lo establecido en el primer párrafo de esta cláusula, en fijar una pena convencional a cargo del \"PRESTADOR DE SERVICIOS\" del 5% (cinco por ciento) del valor total de los trabajos amparados por el presente contrato para el caso de atraso en el tiempo máximo comprometido (terminación total de la obra que se encomienda), por cada"),155,100,'J','T','','false');
$pdf->AddPage();
$pdf->SetXY(30,10);
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("
semana de atraso, con un periodo de gracia de una semana.
...
A la terminación de este contrato el \"PRESTADOR DE SERVICIOS\" y \"ACIMSA\" levantará un acta de recepción que garantice que los trabajos realizados se encuentran en condiciones óptimas, con la firma de aceptación de \"ACIMSA\"."),155,180,'J','T','','false');
$pdf->SetXY(25,235);
$pdf->SetFont('Arial','B',12);
...
2.  Contar con el personal debidamente capacitado para proporcionar servicio de garantía y asegurar así el correcto funcionamiento de las actividades encomendadas del presente de acuerdo con las garantías indicadas en el mismo 
"),155,40,'J','T','','false');
$pdf->AddPage();
$pdf->SetXY(30,10);
$pdf->SetFont('Arial','',12);
...
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("
    Ninguna de las partes deberá efectuar cambio alguno hasta en tanto no exista el acuerdo debidamente firmado por ambas partes."),155,20,'J','T','','false');
$pdf->SetXY(25,30);
$pdf->SetFont('Arial','B',12);
...
Asimismo, el \"El \"PRESTADOR DE SERVICIOS\" será el único responsable de las obligaciones derivadas de las disposiciones legales y demás ordenamientos en la materia de trabajo y seguridad social, respecto al personal que llegaré a intervenir en la prestación de los servicios contratados.  El \"PRESTADOR DE SERVICIOS\" conviene por lo mismo en responder ante el INSTITUTO "),155,50,'J','T','','false');
$pdf->AddPage();
$pdf->SetXY(30,10);
$pdf->SetFont('Arial','',12);
$pdf->drawTextBox(utf8_decode("MEXICANO DEL SEGURO SOCIAL (IMSS), así como cualquier otro organismo público o dependencia, de todas las reclamaciones que sus trabajadores presentasen en su contra o en contra de \"ACIMSA\" o de terceros en relación con los trabajos materia de este contrato.
...
De igual manera el \"PRESTADOR DE SERVICIOS\" se obliga a cubrir los daños y perjuicios que pudieran derivarse de una declaración de responsabilidad solidaria con \"ACIMSA\" en virtud de un incumplimiento de las obligaciones a que se refiere el artículo 14 de la Ley Federal del Trabajo."),155,65,'J','T','','false');
...
___________________________________  
REPRESENTANTE LEGAL          
". utf8_encode($a['3']) .""),90,30,'C','T','','false');
$pdf->SetXY(30,105);
